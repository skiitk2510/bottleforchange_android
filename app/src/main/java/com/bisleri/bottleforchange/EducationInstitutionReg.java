...
public class EducationInstitutionReg extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_education_institution_reg);
        ...
        PostResponseAsyncTask loginTask = new PostResponseAsyncTask(EducationInstitutionReg.this, postData,
                new AsyncResponse() {
                    @Override
                    public void processFinish(String output) {
                        ...
                        ArrayAdapter adapter = new ArrayAdapter(EducationInstitutionReg.this, simple_spinner_dropdown_item, cList);
                        dropdown.setAdapter(adapter);
                    }
                });
        loginTask.execute(getString(R.string.server_path)+"api/get-scool-college-category-relation");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if(name_housing_society_value.matches("")){
                    emptyErrorArray.add("Name of School/College");
                }
                ...
                final PostResponseAsyncTask task = new PostResponseAsyncTask(v.getContext(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String output) {
                        Session session = Session.getInstance(EducationInstitutionReg.this); //in oncreate
                        //and now we set sharedpreference then use this like
                        if (!output.equals("exists")) {
                            session.setUserId(output);
                            session.setCategoryId("2");
                            session.setPin("0");
                            Intent i = new Intent(EducationInstitutionReg.this, OtpActivity.class);
                            i.putExtra("mobile_number", mobileNumber.getText().toString());
                            startActivity(i);
                        } else {

                            Toast.makeText(EducationInstitutionReg.this, "Already registered!", Toast.LENGTH_LONG).show();
        ...
        tncButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(EducationInstitutionReg.this);
