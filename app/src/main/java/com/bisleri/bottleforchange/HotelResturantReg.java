...
public class HotelResturantReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hotel_resturant_reg);
        ...
        PostResponseAsyncTask loginTask = new PostResponseAsyncTask(HotelResturantReg.this, postData,
                new AsyncResponse() {
                    @Override
                    public void processFinish(String output) {
                        ...
                        ArrayAdapter adapter = new ArrayAdapter(HotelResturantReg.this, simple_spinner_dropdown_item, cList);
                        dropdown.setAdapter(adapter);
                    }
                });
        loginTask.execute(getString(R.string.server_path)+"api/get-hotel-category-relation");

        final EditText name_housing_society = findViewById(R.id.editText7);
        //final EditText no_of_households = (EditText)findViewById(R.id.editText8);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                if(name_housing_society_value.matches("")){
                    emptyErrorArray.add("Name of Hotel/Restraunt");
                }
                ...
                final PostResponseAsyncTask task = new PostResponseAsyncTask(v.getContext(), postData, new AsyncResponse() {
                    ...
                    public void processFinish(String output) {
                        ...
                        if(!output.equals("exists")){
                            ...
                            session.setCategoryId("3");
                            session.setPin("0");
                            Intent i = new Intent(HotelResturantReg.this, OtpActivity.class);
                            i.putExtra("mobile_number", mobileNumber.getText().toString());
                            startActivity(i);
                        }
                        else{

                            Toast.makeText(HotelResturantReg.this, "Already registered!", Toast.LENGTH_LONG).show();
                ...
                task.execute(getString(R.string.server_path)+"api/insert_hotel_data");//http://mycrmserver.com/bottle-for-change/public/
            }
        });
        ...
        tncButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(HotelResturantReg.this);
