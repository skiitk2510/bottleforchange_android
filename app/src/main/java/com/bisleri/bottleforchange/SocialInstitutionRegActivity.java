...
public class SocialInstitutionRegActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_social_institution_reg);
        ...
        PostResponseAsyncTask loginTask = new PostResponseAsyncTask(SocialInstitutionRegActivity.this, postData,
                new AsyncResponse() {
                    @Override
                    public void processFinish(String output) {
                        ...
                        ArrayAdapter adapter = new ArrayAdapter(SocialInstitutionRegActivity.this, simple_spinner_dropdown_item, cList);
                        dropdown.setAdapter(adapter);
                    }
                });

        loginTask.execute(getString(R.string.server_path)+"api/get-corporate-category-relation");

        final EditText name_housing_society = findViewById(R.id.editText7);

        final EditText contact_person_name = findViewById(R.id.editText9);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                ArrayList<String> emptyErrorArray  = new ArrayList<String>();
                ArrayList<String> otherErrorArray  = new ArrayList<String>();


                if(name_housing_society_value.matches("")){
                    emptyErrorArray.add("Name of Social Institution");
                }
                ...
                final PostResponseAsyncTask task = new PostResponseAsyncTask(v.getContext(), postData, new AsyncResponse() {
                    @Override
                    public void processFinish(String output) {
                        Session session = Session.getInstance(SocialInstitutionRegActivity.this); //in oncreate
                        //and now we set sharedpreference then use this like
                        if (!output.equals("exists")) {
                            session.setUserId(output);
                            session.setCategoryId("2");
                            session.setPin("0");
                            Intent i = new Intent(SocialInstitutionRegActivity.this, OtpActivity.class);
                            i.putExtra("mobile_number", mobileNumber.getText().toString());
                            startActivity(i);
                        } else {

                            Toast.makeText(SocialInstitutionRegActivity.this, "Already registered!", Toast.LENGTH_LONG).show();
                ...
                task.execute(getString(R.string.server_path)+"api/insert_school_data");//http://mycrmserver.com/bottle-for-change/public/
            }
        });
        ...
        tncButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(SocialInstitutionRegActivity.this);
