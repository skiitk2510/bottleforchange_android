...
public class CorporateRegActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_corporate_reg);

        session = Session.getInstance(this);
        HashMap postData = new HashMap();
        postData.put("id", "value");
        //You pass postData as the 2nd argument of the constructor
        PostResponseAsyncTask loginTask = new PostResponseAsyncTask(CorporateRegActivity.this, postData,
                new AsyncResponse() {
                    @Override
                    public void processFinish(String output) {
                        ...
                        ArrayAdapter adapter = new ArrayAdapter(CorporateRegActivity.this, simple_spinner_dropdown_item, cList);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                String no_of_households_value = "0";
                ...
                ArrayList<String> emptyErrorArray;
                emptyErrorArray = new ArrayList<>();
                ArrayList<String> otherErrorArray  = new ArrayList<>();

                if(name_housing_society_value.matches("")){
                    emptyErrorArray.add("Name of Corporate");
                }
                ...
                final PostResponseAsyncTask task = new PostResponseAsyncTask(v.getContext(), postData, new AsyncResponse() {
                    ...
                    public void processFinish(String output) {
                        ...
                        if(!output.equals("exists")){
                            ...
                            session.setCategoryId("4");
                            session.setPin("0");
                            Intent i = new Intent(CorporateRegActivity.this, OtpActivity.class);
                            i.putExtra("mobile_number", mobileNumber.getText().toString());
                            startActivity(i);
                        }
                        else{

                            Toast.makeText(CorporateRegActivity.this, "Already registered!", Toast.LENGTH_LONG).show();
                ...
                task.execute(getString(R.string.server_path)+"api/insert_corporate_data");//http://mycrmserver.com/bottle-for-change/public/
            }
        });
        ...
        tncButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(CorporateRegActivity.this);
